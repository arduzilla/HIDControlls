...
__ALIGN_BEGIN static uint8_t USBD_HID_CfgDesc[USB_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  0x00,                                               /* bInterfaceSubClass : No specific subclass */
  ...
  HID_EPIN_SIZE,                                      /* wMaxPacketSize: Size based on report */
  0x00,
...
__ALIGN_BEGIN static uint8_t USBD_HID_Desc[USB_HID_DESC_SIZ] __ALIGN_END =
{
  ...
  0x00,                                               /* bCountryCode: Hardware target country */
  0x01,                                               /* bNumDescriptors: Number of HID class descriptors to follow */
  0x22,                                               /* bDescriptorType (0x22 for Report descriptor) */
  HID_JOYSTICK_REPORT_DESC_SIZE,                      /* wItemLength: Total length of Report descriptor */
  0x00,
};
...
__ALIGN_BEGIN static uint8_t HID_JOYSTICK_ReportDesc[HID_JOYSTICK_REPORT_DESC_SIZE] __ALIGN_END =
{
    ...
    // Axes (5 axes, each padded to 16 bits for byte alignment)
    0x05, 0x01,                    // Usage Page (Generic Desktop Controls)
    0x09, 0x30,                    // Usage (X)
    0x09, 0x31,                    // Usage (Y)
    0x09, 0x32,                    // Usage (Z)
    ...
    0x09, 0x34,                    // Usage (Ry)
    0x15, 0x00,                    // Logical Minimum (0)
    0x26, 0xFF, 0x0F,              // Logical Maximum (4095, for 12-bit resolution)
    0x75, 0x10,                    // Report Size (16 bits per axis, with 4 bits padding)
